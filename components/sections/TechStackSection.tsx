...
export function TechStackSection() {
  ...
  const techCategories: TechCategory[] = [
    ...
    },
    {
      ...
      title: 'DevOps & Cloud',
      technologies: ['AWS (Lambda, S3, EC2)', 'Azure DevOps', 'Firebase', 'Docker'],
      color: '#8B5CF6',
    ...
    },
    {
      ...
      title: 'AI & Automation',
      technologies: ['n8n', 'MCP', 'TensorFlow', 'Computer Vision'],
      color: '#EC4899',
      ...
      <div className="container-custom max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {techCategories.map((category, index) => (
            ...
            >
              <div
                className="relative p-8 rounded-3xl border transition-all duration-300 hover:scale-105 hover:shadow-2xl group h-80 flex flex-col"
                style={{
